    ...
    <div className="main-nav-menu-mobile z-50 bg-transparent shadow-sm lg:shadow-none absolute left-0 top-0 bottom-0 right-0 border-r border-slate-400/30 border-dashed w-[270px] md:w-[300px] lg:flex lg:w-[300px] lg:flex-col">
      <button>
        <div className="header-logo p-5 flex items-center space-x-2">
          <h2 className="text-black font-bold text-2xl">Learn</h2>
        </div>
      </button>
      <div className="header-menu lg:hidden">
        <ul className="flex-col space-y-5 px-8 py-5 pb-8 text-semibold font-semibold text-black">
        ...
        <div className="header-button space-y-2">
          <div className="px-6 lg:flex lg:items-center">
            <a
              href="#"
              className="flex items-center text-white justify-center rounded-md border bg-[#1EBFC1] px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200"
            >
              Login
            </a>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="header-button">
            <div className="hidden lg:flex lg:items-center gap-x-2">
              <button className="flex items-center text-black justify-center px-6 py-2.5 font-semibold">
                Sign up
              </button>
